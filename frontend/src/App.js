...
function App() {
    ...
    const fetchRecommendations = async (customerId) => {
        ...
        try {
            ...
            // Parse recommendations to split title and description
            const parsedRecommendations = (response.data.recommendations || []).map(rec => {
                                    ...
                                    <div className="recommendation-list">
                                        {recommendations.map((rec, index) => (
                                            <p key={index} className="recommendation-item">
                                                <span className="recommendation-title">{rec.title}:</span> {rec.description}
                                            </p>
                                        ))}
                                    </div>
                                </div>
